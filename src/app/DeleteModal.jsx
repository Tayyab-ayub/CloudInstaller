...
const DeleteModal = ({ item, onClose, onClickDeletemodal = (id) => { } }) => {
    const dispatch = useDispatch()

    
    const onConfirmTaped = () => {
        onClickDeletemodal(item.id)       
    }

    
    return (
        <div id="popup-modal" tabIndex="-1" className=" fixed inset-0 z-50 flex items-center justify-center w-full h-full overflow-y-auto overflow-x-hidden">
            <div className="relative p-4 w-full max-w-md max-h-full">
                <div className="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
                    ...
                    <div className="p-4 md:p-5 text-center">
                        ...
                        <h3 className="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Are you sure you want to delete this file?</h3>
